...
const Expense = () => {
    ...
    // here i am using typewriter 
    const [text] = useTypewriter({
        words: ['bill', 'money', 'Growth', 'consistency'],
        loop: 0,
        ...
        <> 
           <div className='container'>
               ...
               {islogin ? (
                         ...
                         <>
                           <div className='expense-div-signout'>
                                <img src="./images/img3.jpg" className='expense-div-signout-img' />  
                            <div className='expense-div-signout2'>
                              {/* <span>TrackHere</span><span className='expense-div-signout2-text'>{text}</span> */}
                              <div className='trackhere'>TrackHere</div><div className='expense-div-signout2-text'>{text}</div>
                            </div>
                           </div>
                         </>
               }
